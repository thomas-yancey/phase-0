...
# What changed between the last release and this release?
  # the attr_reader was used for age, making it so the what_is_age method
  # was unneccesary.
# What was replaced?
  # what_is_age method
# Is this code simpler than the last?
  # Yes, one because what_is_age is a bad method name, two it is very clear
  # what calling age would do and is a standard ruby practice.