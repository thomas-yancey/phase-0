...
# What are these methods doing?
  # They are doing the same thing as the attr_reader and attr_writer methods,
  # They are the long form of writing getter and setter methods. They set or get
  # attributes
# How are they modifying or returning the value of instance variables?
  # the setter method will take an argument and set the designated instance variable
  # to that argument. The getter method just returns the instance variable called.
