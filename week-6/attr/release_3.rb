...
# What changed between the last release and this release?
 # change_my_age was replaced by using the attr_writer method for age
# What was replaced?
 # change_my_age method
# Is this code simpler than the last?
 # Yes because having a setter method standardized with the attr_reader
 # is common and it is clearer how to set an age by using .age(new_age)